          ...
          <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
              <div class="col-md-9 ftco-animate mb-5 text-center">
                ...
                <h2 class="mb-0 bread">Nhóm Sản Phẩm {{$nhomsanpham->tennhom}}</h2>
              </div>
            </div>
          </div>
    </section>
			...
			<div class="container">
              ...
              <div class="categories">
                ...
                <ul class="p-0">
                	...
                	<li><a href="{{ route('frontend.sanpham_loai', ['tennhom_slug' => $value->nhomsanpham->tennhom_slug,'tenloai_slug' => $value->tenloai_slug]) }}">{{$value->tenloai}} <span class="fa fa-chevron-right"></span></a></li>
                	 @endforeach
                </ul>
              </div>
            </div>
