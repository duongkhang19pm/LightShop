            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Thêm nhóm sản phẩm</li>
                    </ol>
                </nav>
            </div>
        </div>
                                  ...
                                  <div class="mb-3">
                                        <div class="form-group">
                                            <label class="form-label" for="tennhom">Tên nhóm sản phẩm</label>
                                             <input type="text" class="form-control @error('tennhom') is-invalid @enderror" id="tennhom" name="tennhom" value="{{ old('tennhom') }}"required />
                                             @error('tennhom')
