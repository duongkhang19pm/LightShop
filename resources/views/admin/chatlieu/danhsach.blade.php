    ...
    <section class="section" >
        <div class="card">
            ...
            <div class="card-body "id="table-hover-row">
                <a href="{{route('admin.chatlieu.them')}}" class="btn btn-info mb-2" ><i class="fas fa-plus"></i> Thêm mới</a>
                    ...
                    <tbody >
                         @foreach($chatlieu as $value)
                             <tr>
                              ...
                              <a href="{{route('admin.chatlieu.sua', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
                                <i class="fa fa-pencil-alt"></i>
                                <span class="sr-only">Edit</span>
                              </a>
                          </td>
                          <td>
                              <a href="{{route('admin.chatlieu.xoa', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
