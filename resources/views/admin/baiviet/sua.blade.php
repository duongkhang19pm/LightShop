            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.baiviet')}}">Danh sách bài viết</a></li>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <div class="mb-3">
                                     <label class="form-label" for="tieude">Tiêu đề <span class="text-danger font-weight-bold">*</span></label>
