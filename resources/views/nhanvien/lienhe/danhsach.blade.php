    ...
    <section class="section" >
        <div class="card">
            ...
            <div class="card-body "id="table-hover-row">
                <a href="{{route('nhanvien.lienhe.them')}}" class="btn btn-info mb-2" ><i class="fas fa-plus"></i> Thêm mới</a>
                <table class='table  table-hover' id="table1">
                    ...
                    <tbody >
                         @foreach($lienhe as $value)
                          ...
                          <td>
                              <a href="{{route('nhanvien.lienhe.xoa', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
