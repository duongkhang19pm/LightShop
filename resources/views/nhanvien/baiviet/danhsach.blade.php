    ...
    <section class="section" >
        <div class="card">
            ...
            <div class="card-body "id="table-hover-row">
                <a href="{{route('nhanvien.baiviet.them')}}" class="btn btn-info mb-2" ><i class="fas fa-plus"></i>Thêm mới</a>
                    ...
                    <tbody >
                         @foreach($baiviet as $value)
                            ...
                            <td class="text-center">
                              ...
                              <a href="{{route('nhanvien.baiviet.sua', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
                                <i class="fa fa-pencil-alt"></i>
                                <span class="sr-only">Edit</span>
                              </a>
                          </td>
                          <td>
                              <a href="{{route('nhanvien.baiviet.xoa', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
