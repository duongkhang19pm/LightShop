        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('nhanvien.home') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="{{route('nhanvien.donhang')}}">Danh sách Đơn Hàng</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('nhanvien.donhang.sua',['id'=> $donhang->id]) }}" method="post">
                            @csrf
                                <div class="mb-3">
