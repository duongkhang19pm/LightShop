                         ...
                         @foreach($donhang as $value)
                            ...
                            <td>
                                ...
                                @else
                                    ...
                                    <select id="tinhtrang_id"  onchange="document.location.href = '{{route('nhanvien.donhang.tinhtrang',['id' => $value->id, 'tinhtrang_id' => '1' ])}}'+ this.options[this.selectedIndex].value;">
                              ...
                              <a href="{{route('nhanvien.donhang.sua', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
                                <i class="fa fa-pencil-alt"></i>
                                <span class="sr-only">Edit</span>
                              </a>
                          </td>
                          <td>
                              <a href="{{route('nhanvien.donhang.xoa', ['id' => $value->id])}}" class="btn btn-sm btn-secondary">
