                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                                ...
                                <span>Quản lý Doanh Mục</span>
                            </a>

                            <ul class="submenu ">

                                <li>
                                    <a href="{{route('admin.nhomsanpham')}}">Nhóm sản phẩm</a>
                                </li>

                                <li>
                                    <a href="{{route('admin.loaisanpham')}}">Loại sản phẩm</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.thuonghieu')}}">Thương hiệu</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.xuatxu')}}">Xuất xứ</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.chatlieu')}}">Chất liệu</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.tinhtrang')}}">Tình Trạng</a>
                                </li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="{{route('admin.chude')}}">Chủ Đề</a>
                                </li>

                                <li>
                                    <a href="{{route('admin.baiviet')}}">Bài Viết</a>
                                </li>
